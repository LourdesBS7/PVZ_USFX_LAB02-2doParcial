...
#include "NivelPasto.generated.h"

UCLASS()
class PVZ_USFX_LAB02_API ANivelPasto : public AActor, public ICreadorNivel
{
	GENERATED_BODY()
...
private:
	//The Lodging Actor
	UPROPERTY(VisibleAnywhere, Category = "Nivel de Pasto")
